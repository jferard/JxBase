...
class ReaderDialectFactoryAux implements DialectFactoryAux {
    ...
    public XBaseDialect<DB3Dialect, DB3Access> createDB3Dialect(final TimeZone timeZone,
            ...
            throws IOException {
        return DB3DialectBuilder.create(this.type, this.charset, timeZone).reader(tableName).build();
    }
    ...
    public XBaseDialect<DB4Dialect, DB4Access> createDB4Dialect(final TimeZone timeZone,
                                                                ...
                                                                final Map<String, Object> memoHeaderMeta)
            throws IOException {
        return DB4DialectBuilder.create(this.type, this.charset, timeZone).reader(tableName).build();
    }
    ...
    public XBaseDialect<VisualFoxProDialect, VisualFoxProAccess> createVisualFoxProDialect(
            ...
            throws IOException {
        return VisualFoxProDialectBuilder.create(this.type, this.charset, timeZone).reader(tableName).build();
    }
    ...
    public XBaseDialect<FoxProDialect, DB4Access> createFoxProDialect(
            ...
            final String tableName, final Map<String, Object> memoHeaderMeta)
            throws IOException {
        return FoxProDialectBuilder.create(this.type, this.charset, timeZone).reader(tableName).build();
    }
