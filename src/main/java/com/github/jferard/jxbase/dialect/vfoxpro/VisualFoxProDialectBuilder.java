...
/**
 * A VisualFoxPro dialect builder.
 */
public class VisualFoxProDialectBuilder {
    /**
     * Create the builder
     *
     ...
     * @return the builder
     */
    public static VisualFoxProDialectBuilder create(final XBaseFileTypeEnum type, final Charset charset,
        ...
        return new VisualFoxProDialectBuilder(type, charset, characterAccess, dateAccess, floatAccess,
    ...
    public VisualFoxProDialectBuilder(final XBaseFileTypeEnum type, final Charset charset,
     ...
     * @throws IOException
     */
    public VisualFoxProDialectBuilder reader(final String tableName) throws IOException {
     ...
     * @throws IOException
     */
    public VisualFoxProDialectBuilder reader(final XBaseMemoReader memoReader) {
        this.memoAccess =
     ...
     * @throws IOException
     */
    public VisualFoxProDialectBuilder writer(final String tableName,
