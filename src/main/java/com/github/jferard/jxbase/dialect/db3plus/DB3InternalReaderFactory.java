 ...
 */
public class DB3InternalReaderFactory implements XBaseInternalReaderFactory {
    protected final XBaseDialect dialect;
    protected final TimeZone timezone;

    public DB3InternalReaderFactory(final XBaseDialect dialect, final TimeZone timezone) {
    ...
    public XBaseRecordReader createRecordReader(final InputStream inputStream,
        ...
        return new DB3RecordReader(this.dialect, inputStream, charset, array, this.timezone);
    }
