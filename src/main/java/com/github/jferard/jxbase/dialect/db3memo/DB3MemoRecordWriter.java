...
public class DB3MemoRecordWriter extends BasicRecordWriter implements WithMemoRecordWriter {
    private static final int MILLIS_PER_DAY = 24 * 60 * 60 * 1000;
    protected final XBaseMemoWriter memoWriter;

    public DB3MemoRecordWriter(final XBaseDialect dialect, final OutputStream out,
