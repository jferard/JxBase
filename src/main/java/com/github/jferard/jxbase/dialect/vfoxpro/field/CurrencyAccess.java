...
/**
 * Access (read/write) to currency fields.
 */
public interface CurrencyAccess {
     ...
     * @return the value
     */
    long extractCurrencyValue(byte[] recordBuffer, int offset, int length);

    /**
     * Write the currency value
     ...
     */
    FieldRepresentation getCurrencyRepresentation(String fieldName);
}
