...
public class FoxProInternalWriterFactory extends BasicInternalWriterFactory {
    protected final XBaseMemoWriter memoWriter;

    public FoxProInternalWriterFactory(final XBaseDialect dialect, final TimeZone timezone,
