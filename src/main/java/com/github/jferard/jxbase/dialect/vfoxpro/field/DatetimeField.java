...
public class DatetimeField implements XBaseField<DatetimeAccess> {
    ...
    @Override
    public Date extractValue(final DatetimeAccess access, final byte[] recordBuffer,
                             final int offset) {
        return access.extractDatetimeValue(recordBuffer, offset, this.getValueLength(access));
    }
