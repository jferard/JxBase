...
public class DB3InternalWriterFactory implements XBaseInternalWriterFactory {
    public DB3InternalWriterFactory(final XBaseDialect dialect, TimeZone aDefault) {
    }
    ...
    public XBaseRecordWriter createRecordWriter(final XBaseDialect dialect,
        ...
        return new DB3RecordWriter(dialect, outputStream, charset, array.getFields());
    }
}
