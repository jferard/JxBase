...
public class CurrencyField implements XBaseField<CurrencyAccess> {
    ...
    public CurrencyField(final String name) {
        this.name = name;
    }
    ...
    @Override
    public Long getValue(final CurrencyAccess access, final byte[] recordBuffer, final int offset,
                         final int length) {
        return access.getCurrencyValue(recordBuffer, offset, length);
    }
    ...
    public FieldRepresentation toRepresentation(final CurrencyAccess access) {
        return access.getCurrencyRepresentation(this.name);
    }

    @Override
    public String toString() {
        return "CurrencyField[name=" + this.name + "]";
    }
