...
public class DatetimeField implements XBaseField {
    ...
    public int getByteLength(final XBaseLengths dialect) {
        return dialect.getDatetimeFieldLength();
    }
