...
public class JdbfMain {
	...
	public static void method5(String[] args) throws Exception {
		...
		XBaseReader reader = DbfReader.create(file);
		XBaseMetadata meta = reader.getMetadata();
		System.out.println(meta);
		XBaseRecord rec = null;
		List<XBaseRecord> recs = new ArrayList<XBaseRecord>(10);
		...
		DbfMetadata meta1 = DbfMetadataUtils.fromFieldsString(XBaseFileTypeEnum.FoxBASEPlus1,
...
//		System.out.println(meta);
	...
	public static void method6(String[] args) throws Exception {
        ...
        public static void method7(String[] args) throws FileNotFoundException, IOException, ParseException {
            ...
            DbfMetadata meta = DbfMetadataUtils.fromFieldsString(XBaseFileTypeEnum.dBASEIV3,
	...
	static void testReadWriteReadFile(File file)  throws Exception  {
		...
		{
			XBaseReader reader1 = DbfReader.create(new File("1.dbf"));
			XBaseRecord rec1 = null;
			List<Map<String,Object>> maps2 = new ArrayList<Map<String,Object>>();
			while ((rec1 = reader1.read()) != null) {
				Map<String,Object> map = rec1.toMap(stringCharset);
				maps2.add(map);
			}
			reader.close();
